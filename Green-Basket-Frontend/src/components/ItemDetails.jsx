...
const ItemDetails = () => {
    ...
    const handleAddtoCart = async() =>{
        ...
        const data = await fetch(`http://localhost:3000/api/cart/oneItem/${pdtdetail._id}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({quantity:pdtQuantity})});
